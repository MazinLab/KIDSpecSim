...
Example command line execution with recommended file names:
TODO
"""
...
if __name__ == '__main__':
    ...
    # ==================================================================================================================
    # OPEN FITS FILE AND WAVECAL FILE AND COMBINE
    # ==================================================================================================================
    wavecal_file = np.load(f'{args.wavecal_file}')
    wavecal = wavecal_file['wave_result']
    orders = wavecal_file['orders']
    coef = wavecal_file['coef']

    spectrum = fits.open(f'/home/kimc/pycharm/KIDSpecSim/ucsbsim/{args.fits_file}', mode='update')
    ...
    fits.append(args.fits_file, wavecal, verify=False)

    logging.info(f'The FITS file has been update: {args.fits_file}.')
    ...
    plt.title('Comparison between simulation (red) and wavecal (blue) \n'
              f'{coef.shape[0]-1}x{coef.shape[1]-1} Poly')
