...
def KSIM_looper(mag_reduce_fac,blaze_coords):
    ...
    model_spec1 = (model_spec[0],model_spec[1] / mag_reduce_fac) 
    ...
    if orders_opt[0] != 1:
        ...
        print('\n OPT arm sky photons.')
        pixel_sums_opt_sky,_= grating_binning_high_enough_R_sky_lim_mag(sky_QE,order_wavelengths_opt,order_wavelengths,
                                                      orders_opt,efficiencies_opt,cutoff,IR=False,OPT=True,plotting=extra_plots)
    ...
    if orders_ir[0] != 1:
        ...
        print('\n NIR arm sky photons.')
        pixel_sums_ir_sky,_ = grating_binning_high_enough_R_sky_lim_mag(sky_QE,order_wavelengths_ir,
    ...
    return SNRs_blaze,SIM_obj_mags
...
while stop_condition != len(blaze_wl_mag_found_check):
    ...
    SNRs_blaze,current_mag = KSIM_looper(mag_reduce_fac,blaze_coord)
